...
var data = [
  {
    ...
    shortQuote:
      "By combining ARC’s global airline sales data with our air travel search data, we gain a more complete picture of traveler behavior and shopping trends.",
    productLink:
      "https://www2.arccorp.com/about-us/arc-data/",
    product: "data",
    productName: "ARC Data"
  },
  {
    name: "Mable Tang",
    ...
    shortQuote:
      "ARC’s Airline BI has been adopted by several of our teams at Thai Airways. For our Data Analytics team, the raw data in the tool helps them easily drill down to pinpoint where the trends are coming from and when. For our Sales team, the custom, interactive dashboards save them both time and money from having to navigate through raw data. ",
    productLink:
      "https://www2.arccorp.com/products-participation/products/airline-bi/",
    product: "Airline BI",
  ...
  },
  {
    ...
    product: "Airline BI",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/airline-bi-lot-polish-airlines/",
    productName: "Airline BI"
  },
  {
    name: "Diane Mabard",
    ...
    type: "agency",
    quote:
      "The two biggest successes we’ve seen with Aria are the number of hours saved in completing reports for clients and the ability to see live data during airline meetings.",
    shortQuote:
      "The two biggest successes we’ve seen with Aria are the number of hours saved in completing reports for clients and the ability to see live data during airline meetings.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/aria/",
    product: "Aria",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/great-getaways-travel/",
    productName: "Aria"
  },
  {
    ...
    shortQuote:
      "With several different back-office systems, it previously took a while to do the type of analysis that Agency BI can do in minutes.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/agency-bi/",
    product: "Agency BI",
  ...
  },
  {
    ...
    shortQuote:
      "Airline BI helps us stay on top of trends with a weekly analysis of agency performance and better understanding of how our O&Ds are performing...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/airline-bi/",
    product: "Airline BI",
    productName: "Airline BI"
  },
  {
    ...
    shortQuote:
      "Using ARC’s Revenue Recovery Services, rather than our own resources, has saved us time and money.",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/aeroflot-minimizes-debit-memo-using-memo-analyzer-rrs/",
    productLink:
      "https://www2.arccorp.com/products-participation/products/revenue-recovery-service/",
...

  {
    ...
    type: "agency",
    quote:
      "I don't think travel agencies completely understand the resources ARC provides and the vast knowledge their staff has in the travel industry. Since we are so new to the industry, having a trusted partner to guide us is very powerful.",
    shortQuote:
      "Since we are so new to the industry, having a trusted partner to guide us is very powerful.",
    productLink:
      "https://www2.arccorp.com/products-participation/travel-agencies/become-an-arc-accredited-agent/",
...

  {
    ...
    shortQuote:
      "As a startup and small business in a very crowded and competitive car rental space, AeroGram provides a terrific platform to directly reach a qualified audience of travel agents...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/aerogram/",
    product: "AeroGram",
  ...
  },
  {
    ...
    shortQuote:
      "Having this tool has saved us time in terms of analyzing memo data and identifying where it’s coming from — what the issue actually is.",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/aeroflot-minimizes-debit-memo-using-memo-analyzer-rrs/",
    productLink:
      "https://www2.arccorp.com/products-participation/products/memo-analyzer-for-airlines/",
  ...
  },
  {
    ...
    shortQuote:
      "Direct Data Solutions is the most comprehensive industry data source available today.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/direct-data-solutions",
  ...
  },
  {
    ...
    shortQuote:
      "ARC's data has played an important part in the monthly Travel Trends Index we prepare for the U.S. Travel Association.",
    productLink:
      "https://www2.arccorp.com/about-us/arc-data/",
    product: "data",
    productName: "ARC Data"
  },
  {
    ...
    shortQuote:
      "British Airways is excited to be the first test partner for ARC's enhanced settlement functionality, which enables us to evolve our distribution strategy with the travel agency channel.",
    productLink:
      "https://www2.arccorp.com/products-participation/distribution/",
    product: "debit memos",
  ...
  },
  {
    ...
    shortQuote:
      "This will drive consistency in our processes and allow us to work more effectively with our industry partners.",
    productLink:
      "https://www2.arccorp.com/articles-trends/the-latest/latest01222018/",
    product: "debit memos",
    learnMore:
      "https://www2.arccorp.com/articles-trends/the-latest/latest01222018/",
    productName: "Debit Memos"
  },
  {
    ...
    shortQuote:
      "From Delta's perspective, having best practices in place sets goals and expectations for airlines, agencies and GDS providers allowing all to improve customer service...",
    productLink:
      "https://www2.arccorp.com/articles-trends/the-latest/latest01222018/",
    product: "debit memo",
    learnMore:
  ...
  },
  {
    ...
    shortQuote:
      "The best practices for handling debit memos will enable airlines, travel agencies and GDSs to manage debit memos in a more consistent and efficient manner.",
    productLink:
      "https://www2.arccorp.com/articles-trends/the-latest/latest01222018/",
    product: "debit memos",
    learnMore:
  ...
  },
  {
    ...
    shortQuote:
      "We are grateful for all that ARC has done for us over the years to help us become the successful travel agency we are today.",
    productLink:
      "https://www2.arccorp.com/products-participation/travel-agencies/agency-participation/",
  ...
  },
  {
    ...
    shortQuote:
      "I really do not believe we could have grown and remained in business without ARC.",
    productLink:
      "https://www2.arccorp.com/products-participation/travel-agencies/agency-participation/",
    product: "settlement",
    learnMore:
  ...
  },
  {
    ...
    type: "agency",
    quote:
      "ARC's Aria tool allows me to quickly and effectively analyze sales data, including key financial metrics, to better understand the state of our business, spot trends and forecast more efficiently.",
    shortQuote:
      "ARC's Aria tool allows me to quickly and effectively analyze sales data, including key financial metrics...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/aria/",
    product: "Aria",
    productName: "Aria"
  ...
  },
  {
    ...
    shortQuote:
      "Part of our strategy is working with travel agencies, and the folks at ARC do a great job of helping us partner more closely together.",
    productLink:
      "https://www2.arccorp.com/products-participation/carriers/carrier-participation/",
  ...
  },
  {
    ...
    productLink:
      "https://www2.arccorp.com/products-participation/products/itinerary-detail/",
  ...
  },
  {
    ...
    type: "agency",
    quote:
      "When you're fulfilling travel on behalf of all the different airlines with all different rules, that front line consultant has a difficult job. The benefit ARC brings to us is really how to do that well—how to be educated through the settlement council and the debit memo working group and how to utilize the tools made available to us to make our agents' jobs easier, and allow us to do what we do best: sell travel.",
  ...
  },
  {
    ...
    shortQuote:
      "At Port of Pasco, we look at advance purchases in Market Locator...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/market-locator/",
  ...
  },
  {
    ...
    shortQuote:
      "The Agency BI tool pays for itself. I am now ultra-prepared before airline reviews.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/agency-bi/",
    product: "Agency BI",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/case-study-ovation/",
    productName: "Agency BI"
  },
  {
    name: "Helena Jursca",
...

  {
    ...
    shortQuote:
      "Every single week, China Eastern Airlines uses Direct Data Solutions to enhance our ticketing insight.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/direct-data-solutions/",
    product: "Direct Data Solutions",
    productName: "Direct Data Solutions"
  },
  {
    ...
    shortQuote:
      "With Memo Analyzer, we get a bird's-eye view of all of our memos to understand their root casuses...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/memo-analyzer-for-agencies/",
    product: "Memo Analyzer",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/case-study-tlg/",
  ...
  },
  {
    ...
    shortQuote:
      "...DMWG, with ARC's leadership and guidance, has accelerated positive changes for the industry.",
    productLink:
      "https://www2.arccorp.com/support-training/debit-memo-working-group-dmwg/",
    product: "Debit Memos",
    productName: "Debit Memos"
  },
  {
    ...
    type: "agency",
    quote:
      "I have only had positive experiences with ARC on every level! From customer service to new product development presentations, My ARC and all tools provided are user friendly, intuitive and helpful.",
    shortQuote:
      "...My ARC and all tools provided are user friendly, intuitive and helpful.",
  ...
  },
  {
    ...
    shortQuote:
      "...increased transparency into our debit memo trends allows us to pinpoint and resolve issues quicker.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/memo-manager/",
  ...
  },
  {
    ...
    shortQuote:
      "The up-to-date travel agency data [in Agency List File] helps us to identify new business opportunities for our airline.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/agency-list-file/",
  ...
  },
  {
    ...
    shortQuote:
      "Without ADXMI, I'm blind. Every airline should be using ARC data.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/adxmi/",
    product: "ADXMI",
    productName: "ADXMI"
  },
  {
    ...
    shortQuote:
      "For the first time, we can clearly compare United's performance to its peers and validate our resolution progress.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/memo-analyzer-for-carriers/",
    product: "Memo Analyzer",
    productName: "Memo Analyzer for Airlines"
  },
  {
    ...
    shortQuote:
      "Thanks to Memo Manager/Analyzer, we can quickly pinpoint where we're encountering problems...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/memo-analyzer-for-carriers/",
    product: "Memo Analyzer",
    productName: "Memo Analyzer for Airlines"
  },
  {
    ...
    shortQuote:
      "SAS has used ARC's revenue recovery program for years to streamline the collection of agency debit memos.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/revenue-recovery-service/",
  ...
  },
  {
    ...
    shortQuote:
      "At CCRA, we've used AeroGram to promote a couple of our products to ARC agencies and received better than expected results...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/aerogram/",
    product: "AeroGram",
    productName: "AeroGram"
  },
  {
    ...
    shortQuote:
      "ARC's Global Agency Pro enhances sales operations by connecting them to travel agencies with deep sales experience.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/global-agency-pro/",
  ...
  },
  {
    ...
    shortQuote:
      "Global Agency Pro has been invaluable in assisting Coastal South Carolina with strategic planning around meetings and events in our area...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/global-agency-pro/",
    product: "Global Agency Pro",
    productName: "Global Agency Pro"
  ...
  },
  {
    ...
    shortQuote:
      "As predictors of travel volumes, ARC data has proven immensely valuable.",
    productLink:
      "https://www2.arccorp.com/about-us/arc-data/",
    product: "ARC data",
    productName: "ARC Data"
  },
  {
    ...
    shortQuote:
      "The timeliness of the data in Market Locator is a real differentiator.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/market-locator/",
    product: "Market Locator",
    productName: "Market Locator"
  },
  {
    ...
    shortQuote:
      "ARC’s Airline BI is one of La Compagnie’s most valuable sources of information for comparing performance to its competitors and supporting the airline’s sales and revenue management departments in decision making.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/airline-bi",
    product: "Airline BI",
    productName: "Airline BI"
  },
  {
    ...
    shortQuote:
      "RRS helps us preserve our agency relationships - handling the recovery process, on our behalf, with care.",
    productLink:
      "https://www2.arccorp.com/products-participation/carriers/carrier-participation/",
    product: "ARC",
    productName: "Airline Participation"
  },
  {
    ...
    type: "agency",
    quote:
      "The ARC Specialist Training has been tremendously helpful, especially since I am in the process of starting my own vacation assistance agency. As my business launches, it will be valuable having the knowledge and designation of the ARC Specialist Certification.",
    shortQuote:
      "As my business launches, it will be valuable having the knowledge and designation of the ARC Specialist Certification.",
    productLink:
      "https://www2.arccorp.com/products-participation/travel-agencies/agency-participation/arc-specialist-certification/",
  ...
  },
  {
    ...
    shortQuote:
      "Since having ARC's Memo Analyzer, we have seen debit memos drop drastically...",
    productLink:
      "https://www2.arccorp.com/products-participation/products/memo-analyzer-for-agencies/",
    product: "Memo Analyzer",
    productName: "Memo Analyzer for Agencies"
  },
  {
    ...
    shortQuote:
      "…using [Global Agency Pro], we now have the data and extra time for deeper analysis to increase our destination's success.",
    productLink:
      "https://www2.arccorp.com/products-participation/products/global-agency-pro/",
    product: "Global Agency Pro",
    caseStudy:
      "https://www2.arccorp.com/products-participation/case-studies/case-study-atoutfrance/",
    productName: "Global Agency Pro"
  },
  {
    name: "Allison Bryant",
...
function linkReplace(quote, product, productLink) {
  ...
  productLink =
    '<a href="' +
    productLink +
    '?utm_source=customer_success_stories">' +
    product +
    "</a>";
...
for (var i = 0; i < data.length; i++) {
  var caseStudy =
    data[i].caseStudy != null
      ? '<a class="ctaBtn ctaBtn--graphic ctaBtn--secondary" style="margin: 0px 40px 20px 40px;" href="' +
        data[i].caseStudy +
        '"><span><i class="icon-download"> </i></span> Download Case Study</a>'
      : " ";

  var learnMore =
    data[i].learnMore != null
      ? '<a class="ctaBtn ctaBtn--secondary" style="margin: 0px 40px 20px 40px;" href="' +
        data[i].learnMore +
        '">Learn More</a>'
      : " ";
  ...
  var caseStudyGrid =
    data[i].caseStudy != null
      ? '<a class="ctaBtn ctaBtn--graphic ctaBtn--secondary" href="' +
        data[i].caseStudy +
        '?utm_source=customer_success_stories"><span><i class="icon-download"> </i></span> Download Case Study</a>'
      : " ";

  var learnMoreGrid =
    data[i].learnMore != null
      ? '<a class="ctaBtn" href="' + data[i].learnMore + '">Learn More</a>'
      : " ";

  var productLink =
    data[i].productLink != null
      ? '<a class="ctaBtn" href="' +
        data[i].productLink +
        '?utm_source=customer_success_stories">' +
        data[i].productName +
  ...
  //append grid
  $(".testimonials_container").append(
    '<div class="col-md-12 grid-item ' +
      (sameQuote ? "noArrow" : "") +
      " " +
      data[i].type +
      " " +
      data[i].productName.replace(/ /g, "-") +
      '" data-id="' +
      i +
      '"><a id="' +
      i +
      '" class="anchor"></a><div class="grid-item-inner"> <div class="grid-item-shortquote">"' +
      linkReplace(
        escapeHTML(data[i].shortQuote),
        data[i].product,
        data[i].productLink
      )
        .replace("My ARC", '<a href="https://myarc.arccorp.com">My ARC</a>')
        .replace(
          "Memo Manager",
          "<a href='https://www2.arccorp.com/products-participation/products/memo-manager/'>Memo Manager</a>"
        ) +
      '"</div><div class="grid-item-quote">"' +
      linkReplace(
        escapeHTML(data[i].quote),
        data[i].product,
        data[i].productLink
      )
        .replace("My ARC", '<a href="https://myarc.arccorp.com">My ARC</a>')
      ...
      '"</div><div class="grid-item-middle"><strong>' +
      escapeHTML(data[i].name) +
      "</strong> <em>" +
      escapeHTML(data[i].title) +
      '</em> <span style="color: #999999;">' +
      escapeHTML(data[i].company) +
      '</span></div><div class="meta-links">' +
      productLink +
      caseStudyGrid +
      '</div><div class="grid-tags"><div class="grid-tag">' +
      data[i].type
        .replace("carrier", "Airlines")
        .replace("edu", "Enterprise Data Users") +
      '</div> / <div class="grid-tag">' +
      data[i].productName +
      "</div></div></div></div>"
  );
}
...
$(".grid-item-shortquote, .grid-item-quote").click(function() {
  $(this)
    .parent()
    .find(".grid-item-shortquote")
    .toggle();
  $(this)
    .parent()
    .find(".grid-item-quote")
    .toggle();
});
...
function initProductFilters() {
  ...
  for (var i = 0; i < productNames.length; i++) {
    ...
    var template =
      '<div class="filter_checkbox"><input class="customer_checkbox" type="checkbox" id="' +
      productVal +
      '" name="' +
      productVal +
      '" value="' +
...
$(document).ready(function() {
  $(document).click(function(e) {
    ...
    if (target.hasClass("selectBox")) {
      ...
      target.hasClass("selectOption") &&
      target.closest(".customerBox").length
    ) {
      ...
      target.hasClass("selectOption") &&
      target.closest(".productBox").length
    ) {
      var checkboxName = target.prop("id").replace("-filter", "");
