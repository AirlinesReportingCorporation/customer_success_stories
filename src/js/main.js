...
for (var i = 0; i < data.length; i++) {
  ...
  var caseStudyGrid = (data[i].caseStudy != null) ? '<a class="read-more" href="' + data[i].caseStudy + '">Download Case Study</a>' : ' ';

  var learnMoreGrid = (data[i].learnMore != null) ? '<a class="read-more" href="' + data[i].learnMore + '">Learn More</a>' : ' ';

  var productLink = (data[i].productLink != null) ? '<a class="read-more" href="' + data[i].productLink + '">' + data[i].productName + '</a>' : ' ';
