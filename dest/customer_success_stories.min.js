...
function toggleFilter() {
  if (checkedArray.length == 0) {
    ...
    for (var i = 0; i < checkedArray.length; i++) {
      (0, _jquery2.default)("." + checkedArray[i]).show();
    }
  }
}
...
(0, _jquery2.default)(document).ready(function () {
  (0, _jquery2.default)('.customer_checkbox').click(function () {
    var checkboxName = (0, _jquery2.default)(this).closest('.filter_checkbox').find('.customer_checkbox').val();
    //becomes active
    if (!(0, _jquery2.default)(this).closest('.filter_checkbox').find('span').hasClass("jcf-checked") && checkedArray.indexOf(checkboxName) <= -1) {
  ...
  if (urlParams.indexOf("filters") > -1) {
    ...
    for (var i = 0; i < filters.length; i++) {
      (0, _jquery2.default)("[value='" + filters[i] + "']").click();
    }
  }
});
