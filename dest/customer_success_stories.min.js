...
var data = [{
  ...
  company: "Direct Travel",
  type: "agency",
  quote: "With ARC Pay, ARC's credit card processing system, the amount of time our staff has to spend charging a card is minimal. They are already working in the GDS, and with just a few keystrokes, they are done. This allows them to focus on what's important … selling travel and servicing their customers.",
  shortQuote: "With ARC Pay, ARC's credit card processing solution, the amount of time our staff has to spend charging a card is minimal.",
  ...
  company: "World Travel",
  type: "agency",
  quote: "ARC Pay enables our tickets and service fees to bill simultaneously, so they appear next to each other on the customer's credit card statement, and that means easy reconciliation and fewer disputed charges. ARC Pay also allows us to void charges we'd otherwise have to refund, and that saves us money.",
  shortQuote: "ARC Pay allows us to void charges we'd otherwise have to refund, and that saves us money.",
  productLink: "https://www2.arccorp.com/products-participation/products/travel-agency-service-fee/",
  product: "ARC Pay",
  productName: "ARC Pay"
}, {
  ...
  company: "Frosch",
  type: "agency",
  quote: "The speed at which my staff can add a service fee to a GDS reservation via ARC Pay, ARC's credit card tool is most efficient. ARC Pay offers convenience, access to all card brands, back-office reconciliation and high transaction limits.",
  shortQuote: "ARC Pay offers convenience, access to all card brands, back-office reconciliation and high transaction limits.",
  productLink: "https://www2.arccorp.com/products-participation/products/travel-agency-service-fee/",
  product: "ARC Pay",
  productName: "ARC Pay"
}, {
  ...
  type: "agency",
  quote: "Among Expedia Group sites alone, we see billions of air searches annually. Analyzing these massive data sets with our partners at ARC gives us smart insights that we can pass along to travelers. And travelers benefit because even small, simple insights into the booking process – what time of year or day of week to book, for example – can yield significant savings.",
...
for (var i = 0; i < data.length; i++) {
  ...
  //append grid
  (0, _jquery2.default)(".testimonials_container").append('<div class="col-md-12 grid-item ' + (sameQuote ? "noArrow" : "") + " " + data[i].type + " " + data[i].productName.replace(/ /g, "-") + '" data-id="' + i + '"><a id="' + i + '" class="anchor"></a><div class="grid-item-inner"> <div class="grid-item-shortquote">"' + linkReplace(escapeHTML(data[i].shortQuote), data[i].product, data[i].productLink).replace("My ARC", '<a href="https://myarc.arccorp.com">My ARC</a>').replace("Memo Manager", "<a href='https://www2.arccorp.com/products-participation/products/memo-manager/'>Memo Manager</a>") + '"</div><div class="grid-item-quote">"' + linkReplace(escapeHTML(data[i].quote), data[i].product, data[i].productLink).replace("My ARC", '<a href="https://myarc.arccorp.com">My ARC</a>').replace("Memo Manager", "<a href='https://www2.arccorp.com/products-participation/products/memo-manager/'>Memo Manager</a>") + '"</div><div class="grid-item-middle"><strong>' + escapeHTML(data[i].name) + "</strong> <em>" + escapeHTML(data[i].title) + '</em> <span style="color: #999999;">' + escapeHTML(data[i].company) + '</span></div><div class="meta-links">' + productLink + caseStudyGrid + '</div><div class="grid-tags"><div class="grid-tag">' + data[i].type.replace("carrier", "Airlines").replace("edu", "Enterprise Data Users") + '</div> / <div class="grid-tag">' + data[i].productName + "</div></div></div></div>");
}

(0, _jquery2.default)(".grid-item-shortquote, .grid-item-quote").click(function () {
  (0, _jquery2.default)(this).parent().find(".grid-item-shortquote").toggle();
  (0, _jquery2.default)(this).parent().find(".grid-item-quote").toggle();
});
...
function initProductFilters() {
  ...
  for (var i = 0; i < productNames.length; i++) {
    ...
    (0, _jquery2.default)(".product-filters").after(template);
    var template2 = '<div class="selectOption" id="' + productVal + '">' + productNames[i] + "</div>";
    (0, _jquery2.default)(".productBox .selectOptions").append(template2);
  }
...
function toggleFilter() {
  ...
  if (checkedArray[0] == "" && checkedArray[1] == "") {
    ...
    (0, _jquery2.default)(".productBox .selectOption").show();
  }
  // only customer type
  else if (checkedArray[0].length > 0 && checkedArray[1] == "") {
      (0, _jquery2.default)(".grid-item").hide();
      (0, _jquery2.default)("." + checkedArray[0]).show();
      if (checkedArray[0] == "agency") {
        (0, _jquery2.default)(".productBox .selectOption").hide();

        (0, _jquery2.default)("#Agency-BI").show();
        (0, _jquery2.default)("#Aria").show();
        (0, _jquery2.default)("#ARC-Specialist-Training").show();
        (0, _jquery2.default)("#Memo-Analyzer-for-Agencies").show();
        (0, _jquery2.default)("#ARC-Pay").show();
        (0, _jquery2.default)("#Settlement").show();
        (0, _jquery2.default)("#Custom-Reports").show();
      } else if (checkedArray[0] == "carrier") {
        (0, _jquery2.default)(".productBox .selectOption").hide();

        (0, _jquery2.default)("#AeroGram").show();
        (0, _jquery2.default)("#Airline-BI").show();
        (0, _jquery2.default)("#Direct-Data-Solutions").show();
        (0, _jquery2.default)("#Memo-Analyzer").show();
        (0, _jquery2.default)("#Memo-Analyzer-for-Airlines").show();
        (0, _jquery2.default)("#Revenue-Recovery-Services").show();
        (0, _jquery2.default)("#Settlement").show();
        ...
        (0, _jquery2.default)("#AeroGram").show();
        (0, _jquery2.default)("#Custom-Reports").show();
        (0, _jquery2.default)("#Global-Agency-Pro").show();
        (0, _jquery2.default)("#Market-Locator").show();
      }

      (0, _jquery2.default)(".filtering_options .selectBox .selectOptions").hide();
    }
    // only product type
    else if (checkedArray[1].length > 0 && checkedArray[0] == "") {
        (0, _jquery2.default)(".grid-item").hide();
        (0, _jquery2.default)("." + checkedArray[1]).show();
      }
      //both cusotmer and product type
      else {
          (0, _jquery2.default)(".grid-item").hide();
          (0, _jquery2.default)("." + checkedArray[0] + "." + checkedArray[1]).show();
        }
}
...
(0, _jquery2.default)(document).ready(function () {
  (0, _jquery2.default)(document).click(function (e) {
    ...
    if (target.hasClass("selectBox")) {
      (0, _jquery2.default)(".productBox .selectOptions").hide();
      (0, _jquery2.default)(".customerBox .selectOptions").hide();
      ...
      if (checkboxName != "viewall") {
        (0, _jquery2.default)(".customerBox .selectName").text(target.text());
        checkedArray[0] = checkboxName;
      } else {
        (0, _jquery2.default)(".customerBox .selectName").text("Customer Type");
      }
      (0, _jquery2.default)(".productBox .selectName").text("Product Name");
      ...
      if (checkboxName != "viewlallproduct") {
        (0, _jquery2.default)(".productBox .selectName").text(target.text());
      ...
      (0, _jquery2.default)(".productBox .selectOptions, .customerBox .selectOptions").hide();
      (0, _jquery2.default)(".selectOptions").hide();
      toggleFilter();
    } else {
      if ((0, _jquery2.default)(".selectOptions").is(":visible")) {
        (0, _jquery2.default)(".selectOptions").hide();
        toggleFilter();
      }
    }
  ...
  (0, _jquery2.default)(".clearfilters").click(function () {
    (0, _jquery2.default)(".customerBox .selectName").text("Customer Type");
    (0, _jquery2.default)(".productBox .selectName").text("Product Name");
    (0, _jquery2.default)(".productBox .selectOptions").hide();
    (0, _jquery2.default)(".customerBox .selectOptions").hide();
  ...
  (0, _jquery2.default)("[id='" + filters + "']").click();
  (0, _jquery2.default)(".selectOptions").hide();
});
