...
for (var i = 0; i < data.length; i++) {
  ...
  //append testimonials
  (0, _jquery2.default)(".grid").append('<div class="data-row item-' + i + '"><div class="testimonials-quote">"' + linkReplace(escapeHTML(data[i].quote), data[i].product, data[i].productLink).replace('My ARC', '<a href="https://myarc.arccorp.com">My ARC</a>').replace("Memo Manager", "<a href='https://www2.arccorp.com/products-participation/products/memo-manager/'>Memo Manager</a>") + '"</div>' + caseStudy + learnMore + '<div class="testimonials-meta"><h2 class="leadin-text">' + escapeHTML(data[i].name) + '</h2> ' + escapeHTML(data[i].title) + ', ' + escapeHTML(data[i].company) + ' <br/> </div></div>');

  //append grid
  (0, _jquery2.default)(".testimonials_container").append('<div class="grid-item ' + data[i].type + ' ' + data[i].productName.replace(" ", "-") + '" data-id="' + i + '"><a id="' + i + '" class="anchor"></a><div class="grid-item-inner"> <div class="grid-item-shortquote">"' + escapeHTML(data[i].shortQuote) + '"</div><div class="grid-item-quote">"' + escapeHTML(data[i].quote) + '"</div><div class="grid-item-middle"><strong>' + escapeHTML(data[i].name) + '</strong> <em>' + escapeHTML(data[i].title) + '</em> <span style="color: #999999;">' + escapeHTML(data[i].company) + '</span></div><div class="meta-links">' + productLink + caseStudyGrid + '</div></div></div>');
}
...
(0, _jquery2.default)(document).ready(function () {
  (0, _jquery2.default)('.filter_checkbox').click(function () {
    var checkboxName = (0, _jquery2.default)(this).find('.customer_checkbox').val();
    //becomes active
    if (!(0, _jquery2.default)(this).find('span').hasClass("jcf-checked")) {
